...
using Team = Microsoft_Teams_Graph_RESTAPIs_Connect.Models.Team;
using TeamGuestSettings = Microsoft_Teams_Graph_RESTAPIs_Connect.Models.TeamGuestSettings;
using TeamsApp = Microsoft_Teams_Graph_RESTAPIs_Connect.Models.TeamsApp;
using User = Microsoft_Teams_Graph_RESTAPIs_Connect.Models.User;
...
namespace Microsoft_Teams_Graph_RESTAPIs_Connect.ImportantFiles
{
    ...
    public class GraphService : HttpHelpers
    {
        ...
        public async Task<IEnumerable<ChatMessage>> GetChannelMessages(string accessToken, string teamId, string channelId)
        {
            return await HttpGetList<ChatMessage>($"/teams/{teamId}/channels/{channelId}/messages", endpoint: graphBetaEndpoint);
        }
        ...
        public async Task PostMessage(string accessToken, string teamId, string channelId, ChatMessage message)
        {
            await HttpPost($"/teams/{teamId}/channels/{channelId}/messages",
                message,
                endpoint: graphBetaEndpoint);
        ...
        public async Task PostMessage(string webHookUrl, MessageCard message, string accessToken)
        {
            var response = await HttpPost<string>(webHookUrl, message, null, 3);
        }
